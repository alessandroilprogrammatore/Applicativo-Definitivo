...
public class UtentePanel extends JPanel {
    ...
    private void initializeComponents() {
        ...
        cambiaPasswordButton = new JButton("Cambia Password");
    }
    ...
    private void setupLayout() {
        ...
        // Title
        JLabel titleLabel = new JLabel("Profilo Utente", JLabel.CENTER);
    ...
    private void showModificaProfiloDialog() {
        ...
        confirmButton.addActionListener(e -> {
            ...
            // TODO: Implement update user in controller
    ...
    private void showCambiaPasswordDialog() {
        JDialog dialog = new JDialog(mainFrame, "Cambia Password", true);
        dialog.setLayout(new GridBagLayout());
        ...
        // Buttons
        JPanel buttonPanel = new JPanel(new FlowLayout());
        JButton confirmButton = new JButton("Cambia Password");
        JButton cancelButton = new JButton("Annulla");
